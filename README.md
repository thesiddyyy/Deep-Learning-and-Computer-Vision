...
This repo is structured to help recruiters, students, and engineers easily navigate through my work in Deep Learning and Computer Vision.
...
### 🔹 **1. Deep Learning**
Neural network models built using TensorFlow/Keras.
...
- LSTM / GRU models
- Autoencoders
- Transfer Learning (VGG16, ResNet, MobileNet etc.)
